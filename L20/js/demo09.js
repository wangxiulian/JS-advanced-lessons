...
console.log("a1b2c3d4".match(/1/));//["1", index: 1, input: "a1b2c3d4", groups: undefined]
console.log("a1b2c3d4".match(/f/));//null
console.log("a1b2c3d4".match(/\d/));//["1", index: 1, input: "a1b2c3d4", groups: undefined]
console.log("a1b2c3d4".match(/\d/g));//(4) ["1", "2", "3", "4"]
...
"abcdef21313sfsflsf1223jlnsa".match(/[a-h]/g);//(10) ["a", "b", "c", "d", "e", "f", "f", "f", "f", "a"]
"abcdef21313sfsflsf1223jlnsa".match(/[123efsa]/g);//(20) ["a", "e", "f", "2", "1", "3", "1", "3", "s", "f", "s", "f", "s", "f", "1", "2", "2", "3", "s", "a"]
"abcdef21313sfsflsf1223jlnsa".match(/[^123efsa]/g);//(7) ["b", "c", "d", "l", "j", "l", "n"]
"abcdef21313sfsflsf1223jlnsa".match(/[1-2a-d]/g);//(11) ["a", "b", "c", "d", "2", "1", "1", "1", "2", "2", "a"]
